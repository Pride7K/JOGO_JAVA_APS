...
public class CarregarImagens {
    ...
    public static BufferedImage jogador,pedra,mapaCompleto,parede,pedacoMapa,tijolo,arvore,teste1,inimigo,casa,grama,gramaComTrilha,terra,pedrona,pedronaInvertida;
